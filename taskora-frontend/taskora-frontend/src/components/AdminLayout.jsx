...
const links = [
  ...
  { to: '/admin/applications', icon: 'bi-file-earmark-text-fill', label: 'Applications' },
...
const AdminLayout = () => {
  ...
  return (
    <div className="tk-app">
      <aside className={`tk-sidebar tk-sidebar-admin ${open ? 'open' : ''}`}>
        <Brand />
        <div className="tk-sidebar-section">Admin Panel</div>
        {links.map((l) => (
          <NavLink key={l.to} to={l.to} end={l.end} className="tk-side-link" onClick={close}>
      ...
      <div className="tk-main">
        <header className="tk-topbar">
          ...
          <div className="ms-auto d-flex align-items-center gap-2">
            <span className="tk-icon-btn"><i className="bi bi-bell"></i></span>
            ...
            <div className="d-none d-md-block lh-sm">
              ...
              <div className="text-muted" style={{ fontSize: '0.72rem' }}>Admin</div>
            </div>
          </div>
        </header>
